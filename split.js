...
$(document).ready(function(){
  $(".plus").click(function(){
    $("#multiscroll-nav").toggleClass("lift");
  });
});
...
$(document).ready(function(){
  $("#imgrightone").click(function(){
    $("#divimgrightone").toggleClass("staticfix");
  });
});


$(document).ready(function(){
  $("#imgleftone").click(function(){
    $("#divimgleftone").toggleClass("testic");
  });
});
